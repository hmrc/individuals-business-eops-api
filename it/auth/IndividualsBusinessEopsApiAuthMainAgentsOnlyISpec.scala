...
class IndividualsBusinessEopsApiAuthMainAgentsOnlyISpec extends AuthMainAgentsOnlyISpec {

  val callingApiVersion = "3.0"

  val supportingAgentsNotAllowedEndpoint = "submit-end-of-period-statement"
